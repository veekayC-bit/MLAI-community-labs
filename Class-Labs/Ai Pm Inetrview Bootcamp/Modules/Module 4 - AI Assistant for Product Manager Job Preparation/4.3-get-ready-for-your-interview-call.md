...
## Shortcut: Skip the Manual Steps — Use the `/interview-prep` Skill

Everything you did in Steps 1–4 above — decoding the JD, crafting STAR stories, generating strategic questions — can be done automatically with the `/interview-prep` skill from the Bonus Lesson 4.5.

Instead of running each prompt manually, the skill collects your resume and job description, asks which round you're preparing for, and generates all the prep files in one go.

**To use it:**

1. Make sure you've installed the skill — see [Bonus Lesson 4.5](./Bonus%20-%204.5-how-to-build-strategy-using-claude-code.md) for download and install instructions
...
3. The skill will ask for your resume, job description, and which round — then automatically create:
   - `interview-strategy.md` — JD analysis, positioning, likely HM questions
   - `first-call-stories.md` — 5 STAR stories mapped to the JD
   - `project-discussion-points.md` — 5 projects structured for discussion
   - `round2-prep.md` — deep-dive questions, case studies, strategic questions to ask

> **Use this lesson to understand the thinking behind each step. Use the skill when you need to move fast.**
