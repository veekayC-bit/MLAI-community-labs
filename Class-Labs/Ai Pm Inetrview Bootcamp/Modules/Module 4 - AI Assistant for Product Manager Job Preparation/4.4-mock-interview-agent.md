...
## Pro Tip: Prep Before You Practice

Before running a mock interview with Sarah Chen, use the `/interview-prep` skill from [Bonus Lesson 4.5](./Bonus%20-%204.5-how-to-build-strategy-using-claude-code.md) to generate your prep materials first:

1. Type `/interview-prep` in Claude Code
2. Provide your resume and the job description you're practicing for
3. The skill generates your `first-call-stories.md`, `project-discussion-points.md`, and `interview-strategy.md`
4. Reference those files in this lesson when Sarah asks about your projects and experience

The mock interview agent performs best when your stories and project points are already prepared — so run `/interview-prep` first, then come back here to practice.
